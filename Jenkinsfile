pipeline {
    ...
    environment {
        ...
        TAG = 'latest'
        SSH_KEY_PATH = '/var/jenkins/workspace/fifth.pem'
        ...
        INSTANCE_IP = '13.62.56.11' // Declare as environment variable for global access
        PUBLIC_IP = '13.62.56.11' // Variable to store the public IP of the EC2 instance
    }
